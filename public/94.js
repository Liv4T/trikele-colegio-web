...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1896879009_142_8_142_41_4", "Component mounted.")));
  },
  methods: {
    //metodos del CRUD
    getNames: function getNames() {
      ...
      axios.get(urlUsers).then(function (response) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1896879009_150_16_150_39_4", _this.names)));
      });
    }
  }
});
