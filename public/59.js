  ...
  methods: {
    ...
    validateVoucher: function validateVoucher() {
      ...
      axios.post("/api/customer-voucher/validate", {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1748520792_433_12_433_42_4", _this3.voucher_data)));
        ...
        if (error.response.data) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1748520792_442_14_442_32_4", error)));
        }
      });
    },
