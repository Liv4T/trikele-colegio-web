...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2312279772_503_8_503_41_4", "Component mounted.")));
  },
  methods: {
    ...
    emitMessage: function emitMessage(response) {
      ...
      if (message) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2312279772_655_16_655_46_4", message.file_path)));
      }
    },
