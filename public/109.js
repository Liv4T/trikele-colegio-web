  ...
  methods: {
      ...
      switch (value) {
        case 'importUsers':
          axios.get('/importUsers', this.ExcelFile[0]).then(function (response) {
            ...
            (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1842190245_114_12_114_30_4", error)));
          });
          break;
        ...
        case 'importStudents':
          axios.get('/importStudent', this.ExcelFile[0]).then(function (response) {
            ...
            (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1842190245_123_12_123_30_4", error)));
          });
          break;
        ...
        case 'importTeachers':
          axios.get('/import', this.ExcelFile[0]).then(function (response) {
            ...
            (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("1842190245_132_12_132_30_4", error)));
          });
          break;
      }
    },
    ...
    emitMessage: function emitMessage(response) {
      ...
      if (message) {
        ...
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("1842190245_249_8_249_38_4", message.file_path)));
      }
    },
