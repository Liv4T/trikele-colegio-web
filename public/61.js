  ...
  methods: {
    ...
    validateVoucher: function validateVoucher() {
      ...
      axios.post("/api/customer-voucher/validate", {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3872670550_395_10_395_40_4", _this4.voucher_data)));
        ...
        if (error.response.data) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3872670550_404_12_404_30_4", error)));
        }
      });
    },
