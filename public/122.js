  ...
  methods: {
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3656982567_184_19_184_45_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3656982567_189_12_189_38_4", _this2.nameFile)));
        });
      });
    }
  }
