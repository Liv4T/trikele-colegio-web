    ...
    saveNote: function saveNote() {
      ...
      if (this.id_assign_note === null) {
        axios.post("/AssignNote", {
          ...
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3832040583_355_12_355_30_4", error)));
        });
      } else {
        axios.put("/AssignNote/".concat(this.id_assign_note), {
          ...
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3832040583_384_12_384_30_4", error)));
        });
      }
    },
