...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    DownloadFile: function DownloadFile() {
      window.open("contratoEducativo/".concat(this.motherName, "/").concat(this.fatherName, "/").concat(this.studentName, "/").concat(this.ccMother, "/").concat(this.ccFather, "/").concat(this.ccStudent, "/").concat(this.classStudent, "/").concat(this.contraprestacion, "/").concat(this.yearContraprestacion, "/").concat(this.grade, "/").concat(this.price, "/").concat(this.dateFinish, "/").concat(this.quotes, "/").concat(this.dateInitSchool, "/").concat(this.days, "/").concat(this.month));
    }
  }
});
              ...
              _c("form", [
                _c("div", { staticClass: "row" }, [
                  ...
                  _c("div", { staticClass: "col-12 mt-5" }, [
                    ...
                    _vm._v(" "),
                    _c("label", { attrs: { for: "" } }, [
                      _vm._v("Mes y año de la firma del Contrato")
                    ]),
                    _vm._v(" "),
                    _c("input", {
                      directives: [
