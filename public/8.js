  ...
  methods: {
    ...
    saveDocs: function saveDocs() {
      ...
      axios.post(url, formData).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3962560705_216_10_216_36_4", response.data)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3962560705_220_10_220_36_4", response.data)));
