...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('getCoords').then(function (response) {
      _this.coords = response.data;
    });
    /* eslint-disable */

    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("1197428754_450_8_450_41_4", "Component mounted.")));
  },
  methods: {
    ...
    emitMessage: function emitMessage(response) {
      ...
      if (message) {
        ...
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("1197428754_600_16_600_46_4", message.file_path)));
      }
    },
    chooseFile: function chooseFile() {
      $("#file").click();
    },
    viewInfoCoord: function viewInfoCoord(type, data) {
      this.type_view = type;
      this.data = data;
...
var render = function() {
  ...
  return _c(
    ...
    [
          ...
          _c("div", { staticClass: "card text-center" }, [
            ...
            _c("div", { staticClass: "card-body" }, [
              ...
              _c(
                ...
                _vm._l(_vm.coords, function(coord, key) {
                  return _c("tbody", { key: key }, [
                    _c(
                        ...
                        directives: [
                          {
                            name: "show",
                            rawName: "v-show",
                            value: coord.deleted === 0,
                            expression: "coord.deleted === 0"
                          }
                        ],
                      ...
                      [
                        _c("td", [
                          _vm._v(_vm._s(coord.name + " " + coord.last_name))
                        ]),
                        _vm._v(" "),
                        _c("td", { staticClass: "float-right" }, [
                          _c(
                            "a",
                            {
                              ...
                              on: {
                                click: function() {
                                  return _vm.viewInfoCoord("show", coord)
                                }
                              }
                            },
                          ...
                          _c(
                            "a",
                            {
                              ...
                              on: {
                                click: function() {
                                  return _vm.viewInfoCoord("edit", coord)
                                }
                              }
                            },
                          ...
                          _c(
                            "a",
                            {
                              ...
                              on: {
                                click: function() {
                                  return _vm.viewInfoCoord("delete", coord)
                                }
                              }
                            },
      ...
      _vm._v(" "),
      _c("modal-coord", {
        attrs: { type: _vm.type_view, data: _vm.data, coord: _vm.coord_name }
      })
    ],
    1
  )
