  ...
  methods: {
    create: function create() {
      ...
      firebase__WEBPACK_IMPORTED_MODULE_0__["default"].database().ref('PhotoGallery').push(post).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("4247568208_75_8_75_29_4", response)));
      })["catch"](function (err) {
        var _console2;

        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("4247568208_78_8_78_24_4", err)));
      });
    },
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("4247568208_96_15_96_41_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("4247568208_101_10_101_32_4", _this.img1)));
        });
      });
    }
  }
