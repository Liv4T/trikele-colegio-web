...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get(url).then(function (response) {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3270189427_103_6_103_33_4", _this.classroom)));
    ...
    axios.get(urla).then(function (response) {
      ...
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3270189427_118_8_118_34_4", _this.nameArea)));
    });
    /* eslint-disable */

    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3270189427_120_4_120_37_4", "Component mounted.")));
