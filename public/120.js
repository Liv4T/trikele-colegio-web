...
var init = function init() {
  ...
  if (typeof MediaRecorder === "undefined" || !tieneSoporteUserMedia()) return (
    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("859102034_125_11_127_5_4", "Tu navegador web no cumple los requisitos; por favor, actualiza a un navegador como Firefox o Google Chrome")))
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    onResult: function onResult(data) {
      ...
      /* eslint-disable */
      (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("859102034_243_6_243_41_4", "The blob data:", data)));
      /* eslint-disable */


      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("859102034_244_6_244_73_4", "Downloadable audio", window.URL.createObjectURL(data))));
    ...
    comenzarAGrabar: function comenzarAGrabar() {
      ...
      navigator.mediaDevices.getUserMedia({
        ...
        /* eslint-disable */
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("859102034_294_10_294_28_4", error)));
      });
    },
    ...
    onUpload: function onUpload() {
      ...
      storageRef.on("state_changed", function (snapshot) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("859102034_368_19_368_45_4", error.message)));
      }, function () {
        ...
        storageRef.snapshot.ref.getDownloadURL().then(function (url) {
          ...
          (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("859102034_373_12_373_40_4", _this4.uploadFile)));
        });
      });
    }
  }
