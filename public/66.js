  ...
  mounted: function mounted() {
    ...
    axios.get("/showClass/".concat(this.id_module)).then(function (response) {
      ...
      axios.get("/PIARStudentsByArea/".concat(response.data.area.id, "/").concat(response.data.classroom.id)).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2914195896_352_16_352_34_4", error)));
      });
  ...
  methods: {
    ...
    SaveDataEvent: function SaveDataEvent() {
      ...
      axios.put("/api/teacher/module/".concat(this.id_module, "/class"), this.course).then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2914195896_453_24_453_42_4", error)));
    ...
    onFileChange: function onFileChange(file, item_index) {
      ...
      /* eslint-disable */
      (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2914195896_491_12_491_35_4", item_index)));
      ...
      if (files.length > 0) {
        ...
        (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2914195896_498_16_498_37_4", 'evento')));
    ...
    GetIndicatorsEvent: function GetIndicatorsEvent(activity) {
      ...
      axios.get("/api/achievement/".concat(activity.id_achievement, "/indicator")).then(function (response) {
        ...
        /* eslint-disable */
        (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("2914195896_561_27_561_43_4", err)));
      });
    },
