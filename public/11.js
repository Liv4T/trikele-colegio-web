...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get("/showClass/".concat(this.id_module)).then(function (response) {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("61451522_392_12_392_56_4", 'area_id', response.data.area.id)));
  ...
  methods: {
    ...
    openDocument: function openDocument(resource) {
      ...
      try {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("61451522_447_16_447_36_4", "Falló")));
      }
    },
    ...
    getCourseData: function getCourseData() {
      ...
      if (this.id_class != 0) {
        axios.get("/api/teacher/module/".concat(this.id_module, "/class/").concat(this.id_class)).then(function (response) {
          ...
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("61451522_480_24_480_68_4", "Datos del curso", response.data)));
    ...
    openActivity: function openActivity(id_activity) {
      ...
      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("61451522_510_12_510_59_4", 'Actividad a iterar', this.activity)));
      /*
                  axios
                      .put(
    ...
    openFeedback: function openFeedback(id_activity) {
      ...
      (_console5 = console).log.apply(_console5, _toConsumableArray(oo_oo("61451522_522_14_522_40_4", this.activity)));
    ...
    saveData: function saveData() {
      axios.put("/api/teacher/module/".concat(this.id_module, "/class"), this.course).then(function (response) {
        ...
        /* eslint-disable */
        (_console6 = console).log.apply(_console6, _toConsumableArray(oo_oo("61451522_593_24_593_42_4", error)));
    ...
    onFileChange: function onFileChange(file, item_index) {
      ...
      /* eslint-disable */
      (_console7 = console).log.apply(_console7, _toConsumableArray(oo_oo("61451522_649_12_649_35_4", item_index)));
      ...
      if (files.length > 0) {
        ...
        (_console8 = console).log.apply(_console8, _toConsumableArray(oo_oo("61451522_656_16_656_37_4", "evento")));
    ...
    SaveResponseEvent: function SaveResponseEvent(activity) {
      ...
      /* eslint-disable */
      (_console9 = console).log.apply(_console9, _toConsumableArray(oo_oo("61451522_721_12_721_33_4", activity)));
      ...
      axios.put("/api/student/module/".concat(this.id_module, "/class/").concat(this.id_class, "/activity/").concat(activity.id, "/interaction"), activity).then(function (response) {
        ...
        /* eslint-disable */
        (_console10 = console).log.apply(_console10, _toConsumableArray(oo_oo("61451522_732_24_732_42_4", error)));
