  ...
  methods: {
    ...
    saveData: function saveData() {
      axios.put("/api/teacher/module/".concat(this.course.id_weekly_plan, "/class"), this.course).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("143926818_231_24_231_42_4", error)));
      ...
      imageRef.put(this.file).then(function (snapshot) {
        snapshot.ref.getDownloadURL().then(function (url) {
          axios.post("filesWork", {
            ...
            /* eslint-disable */
            (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("143926818_255_24_255_42_4", error)));
    ...
    deleteFile: function deleteFile(data) {
      ...
      if (window.confirm("Seguro que desea eliminar el documento ".concat(data.name, " ?"))) {
        axios["delete"]("filesWork/".concat(data.id)).then(function (response) {
          ...
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("143926818_272_20_272_38_4", error)));
        });
      }
      /* eslint-disable */


      (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("143926818_275_12_275_29_4", data)));
    },
