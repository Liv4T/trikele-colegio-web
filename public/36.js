    ...
    onFlieChange1: function onFlieChange1(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console = console).log.apply(_console, _toConsumableArray(oo_oo("2888017399_258_18_258_44_4", response.data)));
        });
      }
    },
    ...
    videoFile: function videoFile(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("2888017399_294_20_294_46_4", response.data)));
    ...
    videoFile1: function videoFile1(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("2888017399_319_20_319_46_4", response.data)));
    ...
    videoFile2: function videoFile2(file) {
      ...
      if (files.length > 0) {
        ...
        axios.post("/fileDocument", data).then(function (response) {
          ...
          /* eslint-disable */
          (_console4 = console).log.apply(_console4, _toConsumableArray(oo_oo("2888017399_344_20_344_46_4", response.data)));
