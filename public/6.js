  ...
  methods: {
    ...
    saveDocs: function saveDocs() {
      ...
      axios.post(url, formData).then(function (response) {
        ...
        /* eslint-disable */
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3921035961_162_12_162_38_4", response.data)));
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3921035961_166_12_166_38_4", response.data)));
