...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get('getGrade').then(function (response) {
      ...
      /* eslint-disable */
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("92451290_110_12_110_30_4", error)));
    });
  },
  computed: {
  ...
  methods: {
    gradeSelected: function gradeSelected(grade_id, grade_name) {
      ...
      axios.get("getStudentsByGrade/".concat(grade_id)).then(function (response) {
        ...
        /* eslint-disable */
        (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("92451290_137_16_137_34_4", error)));
      });
    },
    ...
    saveData: function saveData() {
      ...
      data.forEach(function (el) {
        axios.put("/savePromGrade/".concat(el.id), {
          ...
          (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("92451290_178_20_178_38_4", error)));
        });
      });
