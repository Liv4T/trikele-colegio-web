...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    axios.get(url).then(function (response) {
      ...
      (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3217619943_94_6_94_30_4", _this.clases)));
    });
    /* eslint-disable */

    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3217619943_97_4_97_37_4", "Component mounted.")));
  },
  methods: {
