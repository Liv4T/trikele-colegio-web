  ...
  methods: {
    ...
    validateVoucher: function validateVoucher() {
      ...
      axios.post("/api/customer-voucher/validate", {
        ...
        (_console = console).log.apply(_console, _toConsumableArray(oo_oo("209677681_391_10_391_40_4", _this4.voucher_data)));
        ...
        if (error.response.data) {
          ...
          /* eslint-disable */
          (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("209677681_400_12_400_30_4", error)));
        }
      });
    },
