                ...
                <tbody><tr>
                    <td class="rnb-del-min-width" align="center" valign="top" style="min-width:590px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#ffffff" style="background-color: rgb(255, 255, 255); border-radius: 0px; padding-left: 20px; padding-right: 20px; border-collapse: separate;">
                            <tbody><tr>
                                <td height="19" style="font-size:1px; line-height:0px; mso-hide: all;">&nbsp;</td>
                            </tr>
                            <tr>
                                                ...
                                                <table cellpadding="0" border="0" align="center" cellspacing="0" class="logo-img-center">
                                                    <tbody><tr>
                                                        <td valign="middle" align="center" style="line-height: 1px;">
                                                            <div style="border-top:0px None #000;border-right:0px None #000;border-bottom:0px None #000;border-left:0px None #000;display:inline-block; " cellspacing="0" cellpadding="0" border="0"><div><img width="512" vspace="0" hspace="0" border="0" alt="Lendra Estudio" style="float: left;max-width:512px;display:block;" class="rnb-logo-img" src="https://img.mailinblue.com/2666804/images/rnb/original/5e40431b231e37b583512197.jpg"></div></div></td>
                                                    </tr>
                                                </tbody></table>
                                                </td>
                                        </tr>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" align="center" class="rnb-col-1">
                                                    ...
                                                    <tr>
                                                        <td class="content-spacing" style="font-family:'Arial',Helvetica,sans-serif; color:#3c4858; text-align:center;">
                                                            ...
                                                            <span style="color:#3c4858;"><strong><span style="font-size:24px;">Te damos la bienvenida a L4T</span></strong><br>
&nbsp;</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
            ...
            <div style="background-color: rgb(255, 255, 255); border-radius: 0px;">
                ...
                <tbody><tr>
                    <td class="rnb-del-min-width" align="center" valign="top">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="rnb-container" bgcolor="#ffffff" style="background-color: rgb(255, 255, 255); padding-left: 20px; padding-right: 20px; border-collapse: separate; border-radius: 0px; border-bottom: 3px solid rgb(237, 237, 237);">
                                                    ...
                                                    <tbody><tr>
                                                        <th class="rnb-force-col" style="text-align: left; font-weight: normal; padding-right: 0px;" valign="top">
                                                            ...
                                                            <table border="0" valign="top" cellspacing="0" cellpadding="0" width="100%" align="left" class="rnb-col-1">
                                                                ...
                                                                <tbody><tr>
                                                                    <td class="content-spacing" style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858; line-height: 21px;"><div style="text-align: center;"><span style="font-size:16px;">Se solicito recuperar la contraseña, su nueva contraseña es: <strong>{{ $password }}</strong></span></div>
</td>
                                                                </tr>
                                                                </tbody></table>
                                                ...
                                                <table border="0" valign="top" cellspacing="0" cellpadding="0" align="left" class="rnb-col-1" width="550">
                                                    ...
                                                    {{-- </tr><tr>
                                                        ...
                                                        <td style="font-size:14px; font-family:Arial,Helvetica,sans-serif, sans-serif; color:#3c4858; line-height: 21px;">
                                                            <div><div><span style="font-size:16px;">Este es Diago y Benitez, CEO de Live4Teach Bienvenido a esta comunidad de emprendedores del conocimiento!</span></div>

<div><span style="font-size:16px;">Prometemos brindarte una experiencia inolvidable en tu camino de aprendizaje</span></div>
</div>
                                                        </td>
                                                    </tr> --}}
                                                    </tbody></table>
