...
<div >
  <div class="row justify-content-center">
    <div class="col col-lg-8">
       <div class="row justify-content-center">
            <div class="col">
                <div v-if="model.result=='COMPLETED'" class="div-notification noti-success">
                    <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-circle-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                    </svg>
                    <span>TRANSACCIÓN APROBADA</span>
                </div>
                <div v-else-if="model.result=='PENDING'" class="div-notification noti-warning">
                           ...
                           <table class="table table-bordered table-hover">
                                <tbody>
                                    <tr>
                                        ...
                                        <td scope="row" class="text-center">{{model.result}} </td>
                                        <td scope="row" class="text-right"> {{model.amount}} {{model.currency}}</td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <th colspan="2">TOTAL</th>
                                        <th  class="text-right">{{model.amount}} {{model.currency}}</th>
                                    </tr>
                                </tfoot>
                            </table>
                        </div>
