  ...
  <div class="canvas-wrapper" ref="canvasWrapper">
    ...
    <ul class="tools">
      <li id="tool-pencil" :class="{ active: selectedToolIdx === 0 }" @click="changeTool(0)">
        <img src="https://img.icons8.com/nolan/20/000000/paint.png"/>
      </li>
      <li id="tool-eraser" :class="{ active: selectedToolIdx === 1 }" @click="changeTool(1)">
        <img src="https://img.icons8.com/nolan/20/000000/erase.png"/>
      </li>
      <li id="tool-color-palette" @click="showColorPalette()">
        <img src="https://img.icons8.com/nolan/20/000000/paint-palette.png"/>
      </li>
      <li id="tool-download" @click="download()">
        <img src="https://img.icons8.com/nolan/20/000000/downloading-updates.png"/>
      </li>
    </ul>
  </div>
</template>
