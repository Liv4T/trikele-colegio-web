                ...
                <div class="card" v-for="(area, t) in areas" :key="t">
                  ...
                  <div :id="'collapse' + t" class="collapse hide" aria-labelledby="heading" data-parent="#accordionExample">
                    <table class="table table-responsive-xl table-hover table-striped center">
                      ...
                      <tbody>
                        <tr v-for="(clas, k) in clases" :key="k" v-if="clas.id_classroom == area.id_classroom && clas.id_area == area.id">
                          <td><a class="btn btn-primary" :href="'/act_semana/' + clas.id_area + '/' + clas.id_classroom">Editar</a></td>
                          <td>{{ clas.text }}</td>
                          <td>
                            <a class="btn btn-primary" :href="'/admin/modulo/' + clas.id">Ir a Ciclo</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
