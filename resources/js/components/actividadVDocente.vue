            ...
            <div class="card-body">
              <table class="table table-responsive-xl table-hover table-striped center">
                <tbody v-for="(area, t) in areas" :key="t">
                  <tr data-toggle="collapse" :data-target="'#accordion' + t" class="clickable" @click="semanas(area.id, area.id_classroom)">
                    <td>{{ area.text }}</td>
                    <td></td>
                    <td></td>
                    <td></td>
                        ...
                        <table class="table table-responsive table-hover table-striped center">
                          ...
                          <tbody>
                            <tr v-for="(actividad, k) in activities" :key="k">
                              ...
                              <td width="10px">
                                <a class="btn btn-warning btn-sm" v-on:click.prevent="editNames(actividad.id)">
                                  <i class="fa fa-eye"></i>
                                </a>
                              </td>
                            </tr>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="card">
                    <div class="card-header" id="headingOne">
                      <h2 class="mb-0">
                        <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Descripción de la actividad</button>
                      </h2>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingTwo">
                      <h2 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">Logro</button>
                      </h2>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingThree">
                      <h2 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Fecha de entrega</button>
                      </h2>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingFour">
                      <h2 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">Fecha retroalimentación</button>
                      </h2>
                    </div>
                  ...
                  <div class="card">
                    <div class="card-header" id="headingFive">
                      <h2 class="mb-0">
                        <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">Formulario</button>
                      </h2>
                    </div>
                        ...
                        <template v-if="activity.activity_type == 'complete_sentence'">
                          <div v-for="(question, k) in formulario" :key="k">
                            <div class="form-group row mx-auto">
                              ...
                              <input type="text" name="objetive1" class="form-control" v-model="question.questions" disabled />
                            </div>
                            <div class="form-group row" v-for="(res, t) in question.responses" :key="t">
                              <div class="col" v-if="res.correct == true">
                                <label>Respuesta Correcta</label>
                                <input type="text" name="objetive1" class="form-control" v-model="res.answer" disabled />
                              </div>
