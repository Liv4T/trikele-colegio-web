<template>
    <div class="container">
        <div class="row justify-content-center  fondo-amarillo">
            <div class="col-md-5 margin-top-100">
                <div class="card text-center">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <p class="text-justify padding-10">Paga 9 meses y estudia un año</p>
                        </div>
                    </div>
                    <div class="row plan-height">
                        <div class="col-12">
                            ...
                            <span>
                                <strike>$2.699.100</strike>
                                <strong>$1.799.100</strong>
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="row padding-10">
                        <div class="col-12">
                            <button @click="SelectPlanEvent('ANUAL')"   class="btn btn-Azul">Comprar</button>
                        </div>
                    </div>
            ...
            <div class="col-md-5 margin-top-100">
                <div class="card text-center">
                    ...
                    <div class="row padding-10">
                        <div class="col-12">
                            <button @click="SelectPlanEvent('FORMULARIO-ADMISION')"   class="btn btn-Azul">Comprar</button>
                        </div>
                    </div>
            ...
            <div class="col-md-5 margin-top-100">
                <div class="card text-center">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            <h4>FORMULARIO ADMISION + MATRICULA</h4>
                        </div>
                    </div>
                    <div class="row height-50 margin-top-50">
                        <div class="col-12 text-center">
                    ...
                    <div class="row padding-10">
                        <div class="col-12">
                            <button @click="SelectPlanEvent('FORMULARIO-ADMISION-MATRICULA')"   class="btn btn-Azul">Comprar</button>
                        </div>
                    </div>
...
export default {
    ...
    data() {
     ...
     methods:{
         SelectPlanEvent(plan_type){

            if(this.voucher)
            {
                location.href=`/compra/plan/${plan_type}/resumen/v/${this.voucher}`;
            }
            else
            {
                location.href=`/compra/plan/${plan_type}/resumen`;
            }
