...
class CalificationController extends Controller
{
    ...
    public function educativeContract(String $motherName,  String $fatherName, String $studentName, String $ccMother, String $ccFather, String $ccStudent, String $classStudent, String $contraprestacion, String $yearContraprestacion, String $grade, String $price, String $dateFinish, String $quotes, String $dateInitSchool, String $days, String $month){
        $html=" <h1 style='margin-left:22%;'>MATRICULA 2021 – 2022</h1>
            ...
            responsables designados del alumno: <strong>".$studentName."</strong> de la clase, <strong>". $classStudent."</strong> y el Representante Legal ______________________ del establecimiento educativo denominado COLEGIO TRIKELE, 
            ...
            <p>a cancelar como contraprestación al servicio educativo que se le prestará al alumno la suma correspondiente al grado reestudio del mismo a partir del mes de <strong>".$contraprestacion." </strong> de <strong>".$dateFinish."</strong>, </p>
            ...
            por concepto de matrícula y pensión para el grado de <strong>".$grade."</strong> por el valor de <strong>".$price."</strong>,
            ...
            <p style='margin-bottom: 3%;'>Si los responsables legales y/o financieros optan por cancelar en un solo contado, hasta el treinta (30) de <strong>".$month."</strong> de 2021,
            la totalidad de las (<strong>".$quotes."</strong>) cuotas indicadas,
            ...
            <p style='margin-bottom: 3%;'>(mes de <strong>".$dateInitSchool."</strong>),por razones de cambio de sede de trabajo los padres se trasladan a vivir fuera de la ciudad de Bogotá, 
            ...
            <p>El presente contrato podrá ser renovado, de año en año, sin perjuicio del incremento en los costos de matrícula y pensión, 
            ...
            <br>
            <br>
            <p style='margin-bottom: 10%;'>Firmado en Bogotá D.C., a los <strong>".$days."</strong> de <strong>".$month."</strong></p>

            <p style='margin-bottom: 4%;'>Rectora</p>
            <p>_________________________________</p>

            <p style='margin-bottom: 10%;'><strong>PAOLA GARCÍA CASTILLO</strong></p>

            <p style='margin-bottom: 5%;'><strong>RESPONSABLES LEGALES</strong></p>
            ...
            <table style='margin-bottom: 10%;'>
                ...
                <tbody>
                    <tr>
                        <td>CC: <strong>".$ccFather."</strong> </td>
                        <td>CC: <strong>".$ccMother."</strong> </td>
            ...
            <p style='margin-bottom: 10%;'>FIRMA</p>
        ...
        return $pdf->download('Contrato Estudiantil.pdf');
    }
